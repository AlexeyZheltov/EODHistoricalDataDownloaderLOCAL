...
#define MyAppIco    "C:\Users\zhelt\source\repos\EODHistoricalDataDownloader\Setup\appIcon.ico"                      ; Файл с иконкой
#define SetupPath   "C:\Users\zhelt\source\repos\EODHistoricalDataDownloader\Setup\"                        ; Корневая папка
#define FilesPath   "C:\Users\zhelt\source\repos\EODHistoricalDataDownloader\EODHistoricalDataDownloader\bin\Release\net6.0-windows\publish\"  ; Папка с файлами, которые необходимо упаковать
#define ReleasePath "C:\Users\zhelt\source\repos\EODHistoricalDataDownloader\Setup\Release\"                ; Выходная папка
